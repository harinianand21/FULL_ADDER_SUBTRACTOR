...
**Program:**\
module fulladdsub(a,b,cin,sum,carry,BO,DIFF); input a,b,cin; output sum,carry,BO,DIFF;
...
**Result**\
Thus the Full Adder and Full Subtractor circuits are designed and the truth tables is verified
